...
export default class extends Controller {
  static targets = ["form", "submit", "context", "output", "outputWrapper", "loading", "controls", "error"]
  ...
  disableForm() {
    ...
    if (this.hasContextTarget) {
      this.contextTarget.disabled = true
    }
  }
  ...
  enableForm() {
    ...
    if (this.hasContextTarget) {
      this.contextTarget.disabled = false
      this.contextTarget.focus()
    }
  }
